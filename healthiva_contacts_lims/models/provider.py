...
class Provider(models.Model):
    ...
    contract_date=fields.Char(string="Contract Effective Date")
    ...
    tbd_date=fields.Char(string="Transfer to bad Debt Date")
    ...
    delete_date=fields.Char(string="Delete Account Date")
    ...
    admit_date=fields.Char(string="Admit Date/Time")
    discharge_date=fields.Char(string="Discharge Char/Time")
