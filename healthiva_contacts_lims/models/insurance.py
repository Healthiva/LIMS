...
class Insurance(models.Model):
    ...
    plan_effective_date=fields.Char(string="Plan Effective Date/Time")
    plan_expiration_date=fields.Char(string="Plan Expiration Date/Time")
    ...
    insured_dob=fields.Char(string="Insured's Date of Birth")
